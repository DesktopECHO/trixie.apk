...
### Changed
- Operating environment by default: /data/data/com.desktopecho.trixie/linux
...
- Improved command line utility trixie
...
- Support for multiple input devices in framebuffer mode (in xorg.conf changed lines are marked as #trixie)
...
## [1.3.4]
### Added
- Added command status to trixie script
...
- Script trixie can now be run from Android console
- Now can create a symbolic link to trixie in /system/bin (Settings -> Create symlink)
