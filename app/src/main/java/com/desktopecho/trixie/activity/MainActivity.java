...
import com.desktopecho.trixie.Logger;
import com.desktopecho.trixie.PrefStore;
import com.desktopecho.trixie.R;
import com.desktopecho.trixie.UpdateEnvTask;
import com.desktopecho.trixie.receiver.NetworkReceiver;
import com.desktopecho.trixie.receiver.PowerReceiver;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.nav_terminal:
                ...
                // Create a generic Intent to VIEW the RDP file.
                ...
                // --- GENERIC LAUNCH ---
                // Check if there is ANY app on the system that can handle this RDP file intent.
                if (rdpIntent.resolveActivity(getPackageManager()) != null) {
                    // At least one app can handle it. Launch the intent.
                    // Android will show an "Open with..." dialog if there are multiple options.
                    startActivity(rdpIntent);
                } else {
                    // No app on the entire system can open an RDP file.
                    Toast.makeText(this, "No application found that can open RDP files.", Toast.LENGTH_LONG).show();
                }
                break;
