...
import com.desktopecho.trixie.adapter.RepositoryProfileAdapter;
import com.desktopecho.trixie.model.RepositoryProfile;
...
public class RepositoryActivity extends AppCompatActivity {
    ...
    private boolean isDonated() {
        return getPackageManager().checkSignatures(getPackageName(), "com.desktopecho.donate")
        ...
        if (isDonated()) {
            ...
            dialog.setPositiveButton(R.string.repository_purchase_button,
                    (dialog12, whichButton) -> startActivity(new Intent(Intent.ACTION_VIEW,
                            Uri.parse("https://play.google.com/store/apps/details?id=com.desktopecho.donate"))));
        }
