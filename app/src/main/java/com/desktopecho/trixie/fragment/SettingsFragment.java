...
import com.desktopecho.trixie.RemoveEnvTask;
import com.desktopecho.trixie.UpdateEnvTask;
import com.desktopecho.trixie.receiver.BootReceiver;
...
public class SettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (key) {
            ...
            case "stealth":
                // set stealth mode
                // Run app without launcher: am start -n com.desktopecho.trixie/.MainActivity
